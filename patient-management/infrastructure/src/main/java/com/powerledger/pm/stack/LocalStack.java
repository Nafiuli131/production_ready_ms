package com.powerledger.pm.stack;
...
public class LocalStack extends Stack {
        ...
        return DatabaseInstance.Builder
                ...
                .engine(DatabaseInstanceEngine.mysql(
                        MySqlInstanceEngineProps.builder()
                                .version(MysqlEngineVersion.VER_8_0_36) // Latest stable as of mid-2025
                                .build()))
                .vpc(vpc)
    ...
    public static void main(final String[] args) {
        App app = new App(AppProps.builder().outdir("./patient-management/infrastructure/cdk.out").build());
